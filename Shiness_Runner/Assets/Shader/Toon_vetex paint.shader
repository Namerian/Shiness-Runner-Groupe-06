...
////// Emissive:
                ...
                float3 node_3214 = (_Color.rgb*lerp(lerp(_SandDiff_var.rgb,_Diffuse_var.rgb,i.vertexColor.r),_GroundDiff_var.rgb,i.vertexColor.g));
                float3 emissive = node_3214;
